...
// Game Controller
public class HelloControllerGame implements Initializable {
    ...
    AnimationTimer collisionTimer = new AnimationTimer() {
        @Override
        public void handle(long timestamp) {
            //tutaj dodac z innymi enemies i z dobrymi
    ...
    public void checkCollision(Circle shape1, ImageView enemyShape) throws FileNotFoundException {
        if (shape1.getBoundsInParent().intersects(enemyShape.getBoundsInParent())){
            ...
            if (HP<1){
                PrintWriter outputStream = new PrintWriter(new FileOutputStream(new File("D://Studia//JavaProcjets//JavaFXGame0_2//src//main//java//com//example//javafxgame0_2//Data.txt"), true ));
